    ...
    items: [
      {
        ...
        mtd: { direct: 0.00, normal: 0.00 },
        ytd: { direct: 0.00, normal: 3745.39 }
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        mtd: { direct: 0.00, normal: 0.00 },
        ytd: { direct: 0.00, normal: 410.80 }
      },
      {
        machineNo: "AEF",
        description: "EFFLUENT - GENERAL",
        mtd: { direct: 0.00, normal: 0.00 },
        ytd: { direct: 0.00, normal: 57385.93 }
      },
      {
        machineNo: "EFF-FLO",
        description: "EFFLUENT FLOWMETER",
        mtd: { direct: 0.00, normal: 0.00 },
        ytd: { direct: 0.00, normal: 3537.60 }
      },
      {
        machineNo: "EF-MDS",
        description: "MDS EFFLUENT",
        mtd: { direct: 0.00, normal: 0.00 },
        ytd: { direct: 0.00, normal: 211.02 }
      },
      {
        machineNo: "EF-RP",
        description: "ROBIN PUMP",
        mtd: { direct: 0.00, normal: 0.00 },
        ytd: { direct: 0.00, normal: 674.42 }
      },
      {
        machineNo: "EF-ARE",
        description: "WATER PUMP HOUSE",
        mtd: { direct: 0.00, normal: 0.00 },
        ytd: { direct: 0.00, normal: 1699.54 }
      }
    ]
  }
]
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between">
        <h2 className="text-lg font-semibold">Store Issues Report By Machines</h2>
                ...
                <>
                  ...
                  {station.items.map((item) => (
                    <TableRow key={item.machineNo}>
                      ...
                      <TableCell className="text-right">{item.mtd.direct.toFixed(2)}</TableCell>
                      <TableCell className="text-right">{item.mtd.normal.toFixed(2)}</TableCell>
                      <TableCell className="text-right">
                        {(item.mtd.direct + item.mtd.normal).toFixed(2)}
                      </TableCell>
                      <TableCell className="text-right">{item.ytd.direct.toFixed(2)}</TableCell>
                      <TableCell className="text-right">{item.ytd.normal.toFixed(2)}</TableCell>
                    </TableRow>
                  ))}
                  ...
                  <TableRow>
                    ...
                    <TableCell className="text-right font-medium">
                      {(stationTotal.mtd.direct + stationTotal.mtd.normal).toFixed(2)}
                    </TableCell>
                    <TableCell className="text-right font-medium">
